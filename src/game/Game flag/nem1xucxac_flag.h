...
void game_nem1xucxac_flag(){
    ...
    cout << "\n" << mauchude << "[GAME] " << RESET << "NÉM 1 XÚC XẮC" << "\n\n";
    ...
    cout << endl;
    for(int i = 0; i < 5; i++){
        ingiuamanhinh(matxucxac[xucxac1][i], WHITE);
        cout << endl;
    }
    cout << endl;
    ...
    cout << endl;
    for(int i = 0; i < 5; i++){
        ingiuamanhinh(matxucxac[xucxac2][i], WHITE);
        cout << endl;
    }
